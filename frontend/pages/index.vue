...
<!--              </div>-->
            ...
            <div class="mt-2">
              <input
                  ...
                  required
                  class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-sky-600 sm:text-sm/6 hover:scale-105 focus:scale-105 active:scale-105 transition duration-700 ease-bounce" v-model="password"/>
            </div>
          </div>
          ...
          <div>
            <button
                type="submit"
                class="flex w-full justify-center rounded-md bg-sky-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-sky-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600 hover:scale-105 transition duration-700 ease-bounce">Sign in</button>
          </div>
        </form>
      </div>
    </div>
...
function login(e){
  // Prevent page refreshed because of form submit event
  e.preventDefault();
