...
class Transaction(Base):
    ...
    transaction_details = relationship("TransactionDetail", back_populates="transactions")

class TransactionDetail(Base):
    __tablename__ = 'transaction_details'

    transaction_detail_id = Column(Integer, primary_key=True, autoincrement=True)
    transaction_detail_transaction = Column(Integer, ForeignKey('transactions.transaction_id'), nullable=False)
    ...
    # ORM Support
    transactions = relationship("Transaction", back_populates="transaction_details")
